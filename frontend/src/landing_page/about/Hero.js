    ...
    return (
        <div className='container'>
            <div className='row pd-5 mt-5'>
                <h1 className='fs-3 text-center mt-3'>We pioneered the discount broking model in India.
                    <br />Now, we are breaking ground with our technology.</h1>
            </div>

            <div className='row pd-5 mt-5 border-top' style={{lineHeight:"1.8"}}>
                <div className='col-4 para_div' style={{marginLeft:"15%"}}>
                ...
                <div className='col-4 para_div' style={{marginLeft:"5%"}}>
